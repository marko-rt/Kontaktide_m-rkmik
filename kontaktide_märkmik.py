...
#Tekitan 'Ekspordi' nupu funktsiooni, mis salvestab olemasolevad ja lisatud kontaktid tekstifaili (või vajadusel csv faili)
...
#Muudan sisestusväljade paigutust
Label(root, text = 'Nimi:', font = uusFont, fg = '#000000', bg = '#f7f7f7').place(x= 30, y=18)
Entry(root, textvariable = Name, width = 24).place(x= 112, y=25)
Label(root, text = 'Telefon:', font = uusFont, fg = '#000000', bg = '#f7f7f7').place(x= 30, y=48)
Entry(root, textvariable = Number, width = 24).place(x= 112, y=55)
#Lisan aadressi välja
Label(root, text = 'Aadress:', font = uusFont, fg = '#000000', bg = '#f7f7f7').place(x= 30, y=78)
Entry(root, textvariable = Address, width = 24).place(x= 112, y=85)
#Lisan emaili välja
Label(root, text = 'E-mail:', font = uusFont, fg = '#000000', bg = '#f7f7f7').place(x= 30, y=108)
Entry(root, textvariable = Email, width = 24).place(x= 112, y=115)


#Muudan nuppude paigutust, dimensioone ning värve

Button(root,text="LISA", width = 20, font = uusFont, fg = '#ffffff', bg='#611759', command = AddContact).place(x= 30, y=150)
Button(root,text="MUUDA",  width = 20, font = uusFont, fg = '#ffffff', bg='#611759',command = EDIT).place(x= 30, y=250)
Button(root,text="KUSTUTA", width = 20, font = uusFont, fg = '#ffffff', bg='#611759',command = DELETE).place(x= 30, y=350)
Button(root,text="VAATA", width = 20, font = uusFont, fg = '#ffffff', bg='#611759', command = VIEW).place(x= 30, y=200)
Button(root,text="VÄLJU", width = 20, font = uusFontRasvane, fg = '#000000', bg='#bad405', command = EXIT).place(x= 30, y=462)
Button(root,text="LÄHTESTA", width = 20, font = uusFont,  fg = '#ffffff', bg='#611759', command = RESET).place(x= 30, y=300)
Button(root,text="EKSPORDI", width = 20, font = uusFont, fg = '#ffffff', bg='#611759', command = ekspordiKontaktid).place(x= 30, y=400)
